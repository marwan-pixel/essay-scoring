...
) ENGINE=InnoDB AUTO_INCREMENT=74939 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `cbt_progstudi` (
  `kd_progstudi` varchar(1) NOT NULL DEFAULT '',
  `nama_progstudi` varchar(50) NOT NULL,
